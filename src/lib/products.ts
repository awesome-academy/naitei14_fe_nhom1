...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Độ cồn: 12%",
      "Dung tích: 750ml",
      "Phương pháp: Méthode Champenoise",
    ],
  },
  {
    id: 6,
    ...
    category: "Champagne",
    description:
      "Champagne Brut Reserva với chất lượng cao cấp, bọt khí tinh tế và hương vị cân bằng hoàn hảo.",
    rating: 5,
    reviews: 35,
    inStock: true,
    features: [
