...
const CommentsSection = () => {
  const [comments, setComments] = useState([
    {
      ...
      timeAgo: "2 giờ trước",
      content:
        "Bài viết rất hay và có ích! Mình đã áp dụng một số phương pháp được đề cập và thấy hiệu quả tích cực. Cảm ơn tác giả đã chia sẻ những kinh nghiệm quý báu này.",
      likes: 12,
      liked: false,
      replies: [
        {
          ...
          timeAgo: "1 giờ trước",
          content:
            "Cảm ơn bạn đã đọc và phản hồi tích cực! Rất vui khi biết bài viết có thể giúp ích cho bạn.",
          likes: 3,
          liked: false,
          replies: [],
        },
    ...
    },
    {
      ...
      timeAgo: "4 giờ trước",
      content:
        "Quan điểm của bài viết khá thú vị, tuy nhiên mình nghĩ còn thiếu một số case study cụ thể để minh họa. Có thể tác giả sẽ bổ sung thêm trong các bài viết tiếp theo?",
      likes: 8,
      liked: true,
      replies: [],
    },
    {
      ...
      timeAgo: "6 giờ trước",
      content:
        "Mình đã bookmark bài viết này để đọc lại. Nội dung rất chi tiết và dễ hiểu. Đặc biệt phần phân tích về xu hướng thị trường rất có giá trị tham khảo.",
      likes: 5,
      liked: false,
      replies: [],
    },
  ...
  const handleReport = (commentId: any) => {
    alert(
      "Báo cáo đã được gửi. Chúng tôi sẽ xem xét và xử lý trong thời gian sớm nhất."
    );
  };
