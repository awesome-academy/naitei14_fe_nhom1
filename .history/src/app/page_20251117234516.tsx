...
// --- MOCK DATA SECTION ---
// Define mock data structures that match what your components expect.
...
const mockProduct = {
  ...
  // Add other properties like description, type, etc., as needed
};
...
const mockBlogPost = {
  ...
  image: "/Image_Rudu/mock-blog-img.jpg",
  // Add date, content preview, etc.
};
...
const mockGallery = [
  { id: 1, url: "/Image_Rudu/gallery-1.jpg", alt: "Gallery Item 1" },
  { id: 2, url: "/Image_Rudu/gallery-2.jpg", alt: "Gallery Item 2" },
];

// --- END MOCK DATA SECTION ---

export default async function HomePage() {
  // Use mock data directly instead of calling functions that hit the API
  ...
  const galleryData = mockGallery; // Use the mock data for gallery
