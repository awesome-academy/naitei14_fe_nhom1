...
import titleleftdark from "@/src/public/Image_Rudu/titleleft-dark.png";
...
// Định nghĩa hàm registerUser mock để thay thế cho hàm register
// Trong dự án thực tế, bạn sẽ import hàm này từ dịch vụ auth của mình.
const registerUser = async (data: any) => {
  // Mô phỏng cuộc gọi API (2 giây độ trễ)
  console.log("Đang đăng ký với dữ liệu:", data);
  await new Promise((resolve, reject) => {
    setTimeout(() => {
      // Bạn có thể mô phỏng lỗi bằng cách thêm một điều kiện ở đây
...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      // Nếu thành công, chuyển hướng đến trang đăng nhập hoặc trang chủ
