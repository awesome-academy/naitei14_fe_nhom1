...
// Giả định ROUTE_MAP được định nghĩa ở đây cho mục đích hiển thị
const ROUTE_MAP = {
  "trang chủ": "/",
  "tài khoản": "/account",
};
...
const TopNavbar = () => {
  ...
  return (
    ...
    <nav
      className="w-full h-full border-b bg-cover bg-center bg-no-repeat h-[80vh] min-h-[500px] flex flex-col justify-end"
